...
ALTER TABLE "UserData" ADD COLUMN IF NOT EXISTS mbti TEXT;
ALTER TABLE "UserData" ADD COLUMN IF NOT EXISTS relationship TEXT;
ALTER TABLE "UserData" ADD COLUMN IF NOT EXISTS pets BOOLEAN;
ALTER TABLE "UserData" ADD COLUMN IF NOT EXISTS kids BOOLEAN;
ALTER TABLE "UserData" ADD COLUMN IF NOT EXISTS drives BOOLEAN;
ALTER TABLE "UserData" ADD COLUMN IF NOT EXISTS zodiac TEXT;
ALTER TABLE "UserData" ADD COLUMN IF NOT EXISTS education TEXT;
ALTER TABLE "UserData" ADD COLUMN IF NOT EXISTS languages TEXT[];
